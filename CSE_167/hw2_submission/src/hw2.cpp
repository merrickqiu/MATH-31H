...
bool inTriangle(Vector2 p, Vector2 q0, Vector2 q1, Vector2 q2) {
    ...
    bool b0 = dot(p - q0, n0) > -1e-6;
    bool b1 = dot(p - q1, n1) > -1e-6;
    bool b2 = dot(p - q2, n2) > -1e-6;
    bool notb0 = dot(p - q0, n0) < 1e-6;
    bool notb1 = dot(p - q1, n1) < 1e-6;
    bool notb2 = dot(p - q2, n2) < 1e-6;
